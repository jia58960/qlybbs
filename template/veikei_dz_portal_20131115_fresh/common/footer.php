...
<!--{if empty($topic) || ($topic[usefooter])}-->
	...
	<div id="ft" class="wp cl">
		...
		<div id="frt">
			<p>Powered by <strong><a href="http://www.discuz.net" target="_blank">Essence</a></strong><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}--></p>
			<p class="xs0">&copy; 2012-2013 <a href="http://www.comsenz.com" target="_blank"亿讯</a> Templated By <a href="http://www.sz-kingray.com" target="_blank">KingRay IT Group</a> </p>
		</div>
		<!--{eval updatesession();}-->
