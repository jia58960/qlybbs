...
0
|| checktplrefresh('./template/tqun/common/header.htm', './template/tqun/common/header_common.htm', 1386857821, '9', './data/template/9_9_common_header_portal_list.tpl.php', './template/tqun', 'common/header_portal_list')
|| checktplrefresh('./template/tqun/common/header.htm', './template/tqun/common/pubsearchform.htm', 1386857821, '9', './data/template/9_9_common_header_portal_list.tpl.php', './template/tqun', 'common/header_portal_list')
;?>
